...
get_messages <- function(filename,model) {
	...
	entry_regex <- "([0-9][0-9]?[/])([0-9][0-9]?[/])[0-9]{2}[0-9]?[0-9]?[,] ([0-9]{2}[:][0-9]{2}) [-].+"
	...
	messages_regex <- "([0-9][0-9]?[/])([0-9][0-9]?[/])[0-9]{2}[0-9]?[0-9]?[,] ([0-9]{2}[:][0-9]{2}) [-].+"
	...
	msg_regex  <- '.+'
	  ...
	  date_regex <- "([0-9][0-9]?[/])([0-9][0-9]?[/])[0-9]{2}[0-9]?[0-9]?[,] ([0-9]{2}[:][0-9]{2})"
	  #user_regex <- '^[^-].+[:] '
	  #user_regex<-'^ [-] ([[a-z]][ ]?)+[:]'
	  #user_regex2<-' [-] ([a-z][ ]?)+[:]'
	  user_regex <- '^[^:]+[:] '
